import { ActionsProtectedPersonsDashboard, HeroDashboard, Main, ProtectedPersonsDashboard, SectionOverviewContainer } from "@/components";
    ...
    return (
        <Main variant={ variantClass }>
            <SectionOverviewContainer>
                ...
                <ActionsProtectedPersonsDashboard page={page}/>
            </SectionOverviewContainer>
        </Main>
    )
}
